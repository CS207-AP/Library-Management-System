...
<nav class="navbar navbar-dark bg-dark">
  ...
  <td width="50%"><div><form action="ControllerServlet" method="post"><input type="hidden" id="action" name="action" value="calling_edit_books"/><input class="btn btn-link" type="submit" value="View Book List"/></form></div></td>
