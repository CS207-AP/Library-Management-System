        ...
        <div class="col-md-12">
          <form id="create_book" class="" action="ControllerServlet" method="post">
            <div class="form-group row"> <label for="inputmailh" class="col-2 col-form-label">E-mail</label>
              <div class="col-10">
                <input form="login_form" type="text" class="form-control" id="title" placeholder="Macbeth"> </div>
            </div>
            <div class="form-group row"> <label for="inputpasswordh" class="col-2 col-form-label">Password</label>
              <div class="col-10">
                <input form="login_form" type="text" class="form-control" id="author" placeholder="Shakespeare"> </div>
            </div>
            <div class="form-group row"> <label for="inputmailh" class="col-2 col-form-label">Genre</label>
              <div class="col-10">
                <input form="login_form" type="text" class="form-control" id="genre" placeholder="Fiction"> </div>
            </div>
            <div class="form-group row"> <label for="inputmailh" class="col-2 col-form-label">Publisher</label>
              <div class="col-10">
                <input form="login_form" type="text" class="form-control" id="publisher" placeholder="Oxford"> </div>
            </div>
            <div class="form-group row"> <label for="inputmailh" class="col-2 col-form-label">Number of Copies</label>
              <div class="col-10">
                <input form="login_form" type="number" class="form-control" id="number_of_copies" placeholder="10" min="1" max="20"> </div>
            </div>
